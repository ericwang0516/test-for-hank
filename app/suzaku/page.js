  ...
  return (
    <Container size="2" py="9">
      ...
      <Section size="1">
        ...
        <Heading size="8" mb="3" weight="bold">
          雪上摩托車 - Suzaku
        </Heading>
        <Text size="4" color="gray" as="p" mb="6" style={{ maxWidth: 520 }}>
      ...
      <Section size="1" mt="6">
        ...
        <Text size="3" color="gray" as="p" style={{ maxWidth: 520 }}>
        ...
        <Text size="3" color="gray" as="p" mt="4" style={{ maxWidth: 520 }}>
